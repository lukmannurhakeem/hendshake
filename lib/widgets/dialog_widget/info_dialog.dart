...
import 'package:hendshake/services/dialog_services.dart';
          ...
          child: ConstrainedBox(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ListTile(title: Text(title), trailing: const Icon(Icons.close)),
                  Container(
                    color: Colors.white,
                    width: width * 0.83,
                    padding: EdgeInsets.symmetric(vertical: width * 0.1, horizontal: width * 0.04),
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: <Widget>[
                      ...
                      children: <Widget>[
                        cancelText == null
                            ...
                            : TextButton(
                                ...
                                child: Text(
                                  cancelText ?? '',
                                  style: context.titleM!.copyWith(color: ColorConstant.primaryColor),
                                ),
                              ),
                        Container(
