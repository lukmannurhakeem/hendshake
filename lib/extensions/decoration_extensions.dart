...
BorderRadius radius([double? radius]) {
  return BorderRadius.all(radiusCircular(radius ?? ConstantValue.defaultRadius));
}

/// returns Radius
Radius radiusCircular([double? radius]) {
  return Radius.circular(radius ?? ConstantValue.defaultRadius);
}

ShapeBorder dialogShape([double? borderRadius]) {
  return RoundedRectangleBorder(
    borderRadius: radius(borderRadius ?? ConstantValue.defaultRadius),
  );
}
...
Decoration boxDecorationRoundedWithShadow(
  ...
  return BoxDecoration(
    boxShadow: defaultBoxShadow(
      shadowColor: shadowColor ?? ConstantValue.shadowColorGlobal,
      blurRadius: blurRadius ?? ConstantValue.defaultBlurRadius,
      spreadRadius: spreadRadius ?? ConstantValue.defaultSpreadRadius,
      offset: offset,
    ),
    color: backgroundColor,
    gradient: gradient,
...
List<BoxShadow> defaultBoxShadow({
  ...
  return <BoxShadow>[
    BoxShadow(
      color: shadowColor ?? ConstantValue.shadowColorGlobal,
      blurRadius: blurRadius ?? ConstantValue.defaultBlurRadius,
      spreadRadius: spreadRadius ?? ConstantValue.defaultSpreadRadius,
      offset: offset,
    ),
