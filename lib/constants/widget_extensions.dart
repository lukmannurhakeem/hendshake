...
import 'package:hendshake/extensions/decoration_extensions.dart';
...
extension WidgetExtension on Widget? {
  ...
  /// return margin top
  Container marginTop(double top) {
    return Container(margin: EdgeInsets.only(top: top), child: this);
  }

  /// return margin left
  Container marginLeft(double left) {
    return Container(margin: EdgeInsets.only(left: left), child: this);
  }

  /// return margin right
  Container marginRight(double right) {
    return Container(margin: EdgeInsets.only(right: right), child: this);
  }

  /// return margin bottom
  Container marginBottom(double bottom) {
    return Container(margin: EdgeInsets.only(bottom: bottom), child: this);
  }

  /// return margin all
  Container marginAll(double padding) {
    return Container(margin: EdgeInsets.all(padding), child: this);
  }

  /// return custom margin from each side
  ...
  /// return margin symmetric
  Container marginSymmetric({double vertical = 0.0, double horizontal = 0.0}) {
    return Container(
  ...
  Widget onTap(
    ...
    return InkWell(
      ...
      borderRadius: borderRadius ??
          (ConstantValue.defaultInkWellRadius != null ? radius(ConstantValue.defaultInkWellRadius) : null),
      child: this,
      splashColor: splashColor ?? ConstantValue.defaultInkWellSplashColor,
      hoverColor: hoverColor ?? ConstantValue.defaultInkWellHoverColor,
      highlightColor: highlightColor ?? ConstantValue.defaultInkWellHighlightColor,
    );
  }
  ...
  Widget commonContainer({required double width, Color? color, bool? isElevated}) {
    return Container(
      width: width,
