...
class CommonNoDataError extends StatelessWidget {
  ...
  CommonNoDataError({super.key, required this.text, this.callback, this.titleButton, this.isError});
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Container(
            width: _width,
            margin: EdgeInsets.symmetric(horizontal: _width * 0.06, vertical: _width * 0.05),
            child: Column(
          ...
          if (callback != null)
            CommonButton(title: titleButton ?? "", callBack: callback!)
                .marginSymmetric(horizontal: _width * 0.08, vertical: _width * 0.1)
        ],
      ),
    );
  }
