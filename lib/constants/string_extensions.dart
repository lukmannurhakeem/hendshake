...
import 'package:hendshake/constants/pattern.dart';
...
extension StringExtension on String? {
  ...
  String? get ifDebugging => kDebugMode ? this : '';

  String get removeException => this!.replaceAll("Exception:", "");
  String get removeCustomException => this!.replaceAll("Exception: CustomException: ", "");
  ...
  ///Tittle Case
  String toTitleCase() =>
      this!.replaceAll(RegExp(' +'), ' ').split(' ').map((str) => str.capitalizeFirstLetter()).join(' ');
  ...
  Color toColor({Color? defaultColor}) {
    return ColorConstant.getColorFromHex(this!, defaultColor: defaultColor);
  }
