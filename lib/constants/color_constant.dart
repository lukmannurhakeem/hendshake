...
import 'package:hendshake/constants/string_extensions.dart';

class ColorConstant {
  // 0xFF00C53B
  static Color mainColor = const Color(0xFFA0CF68);
  static Color titleColor = const Color(0xFF4BCD5C);
  ...
  static const Color primaryColor = const Color(0xFFd00000);
  static const Color secondaryColor = const Color(0xFFeeeeee);
  static const Color primaryDarkColor = const Color(0xff004a42);
  static const Color primaryLightColor = const Color(0xFFe0f1f2);
  static const Color headerTextColor = const Color(0xFF081F51);
  static const Color secondHeaderTextColor = const Color(0xFF50D5B7);
  static const Color textPrimaryColorGlobal = const Color(0xFF2E3033);
  static const Color textSecondaryColorGlobal = const Color(0xFF757575);
  static const Color scaffoldLight = const Color(0xFFF4F4F4);
  static const Color scaffoldLightColor = const Color(0xFFEBF2F7);
  static const Color scaffoldDarkColor = const Color(0xFF12181B);
  static const Color cardDarkColor = const Color(0xFF2A2E35);
...
// Dark Theme Colors
  static Color appBackgroundColorDark = Color(0xFF262626);
