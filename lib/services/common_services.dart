...
class CommonService {
  ...
  static Future<String?> encrypt(String plainText) async {
    try {
      final String encryptedText = await platform.invokeMethod('encrypt', {'plainText': plainText});
  ...
  static bool isDarkColor(Color color) {
    return ThemeData.estimateBrightnessForColor(color) == Brightness.light || color == Colors.transparent
        ? false
        : true;
  }
}
